...
data <- read.table("https://cdn.theforage.com/vinternships/companyassets/iB2fcueoSnY3w6vhG/D2tEML7fimcdWxai3/1670256455967/Input%20data.txt", sep='\t', header=TRUE)
...
[Answer:]{.underline} \*\*The format of NGN2_MOI and NT3_ng columns is now showing as “<fctr>” rather than the numeric formats “<dbl>” or “<int>” \*\*.
...
[Answer]{.underline}: \*\* The error bars are huge, so NT3 treatment explains only a relatively small part of the variation in MAP2 positivity across conditions. \*\*.
...
[Answer:]{.underline} \*\* All treatments and doses analysed. \*\*.
...
[Answer:]{.underline} \*\* NGN2 virus transduction at 5 MOI. \*\*.
...
[Answer]{.underline}: \*\* NGN2 - 2 MOI; NT3 - 10 ng/mL. \*\*.
...
[Answer]{.underline}: \*\*All of them, but as expected, the biggest change is for the 2 MOI treatment. \*\*.

| - Has the apparent optimal experimental condition changed after removing the outlier (and if so, how)?
| 
| 

[Answer]{.underline}: \*\* No, it remains the same \*\*.
...
[Answer:]{.underline} \*\* I recommend using 5 MOI of NGN2 virus and 10 ng/mL NT3 supplement. \*\*.
